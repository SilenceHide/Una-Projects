          ...
          <div className="checkout_wrapper flex flex-col">
            ...
            <div className="checkout_main-wrapper flex flex-col xl:flex-row justify-between lg:mt-14 mt-8 gap-10 xl:items-start items-center">
              ...
              <div className="checkout_right-wrapper xl:w-[560px] sm:w-full w-[343px] bg-white border-t-[3px] border-accent-color py-10 shadow-main-box-shadow flex xl:flex-col md:flex-row flex-col justify-around">
                ...
                <div className="checkout_shipping-payment_wrapper flex flex-col md:py-10 lg:px-10 md:px-8 px-10  py-8 border-b border-disable-color xl:border-b md:border-b-0 xl:border-x-0 md:border-x">
                  <div className="checkout_shipping-methods_wrapper flex gap-6 flex-col"></div>
                  <div className="checkout_products-divider w-full h-[1px] bg-disable-color md:my-10 my-8"></div>
                </div>
                <div className="checkout_promo-code lg:px-10 px-3 py-5 border-b border-disable-color flex items-center justify-between">
                ...
                <div className="checkout_checkout-wrapper lg:px-10 md:px-3 px-10 md:pt-10 pt-6 flex flex-col gap-4 justify-between">
                  ...
                  <button className="checkout_checkout-btn text-white bg-disable-color flex justify-center items-center gap-[14px] w-full h-[60px] mt-4 px-3 xl:mb-0 md:mb-6 mb-0">
