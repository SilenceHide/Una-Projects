        ...
        <div className="container">
          <div className="login_wrapper flex flex-col">
            ...
            <div className="login_main-wrapper max-w-[600px] w-full m-auto lg:mt-[60px] mt-10 flex flex-col gap-[30px]">
              ...
              <div className="login_social-media bg-white w-full sm:px-[80px] sm:py-[60px] px-4 py-6 flex sm:flex-row flex-col justify-between items-center sm:gap-0 gap-4">
