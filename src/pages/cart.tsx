      ...
      <main className="main-cart lg:pt-10 pt-24 pb-[100px] bg-main-bg-color">
        <div className="container">
          <div className="cart_wrapper flex flex-col">
            ...
            <div className="cart_main-wrapper flex justify-between mt-14">
              <div className="cart_left-wrapper flex flex-col bg-white px-10">
                <div className="cart_product-wrapper flex items-center gap-[140px] border-b border-disable-color py-10">
                  <div className="cart_product_info-wrapper flex gap-[30px]">
                    <div className="cart_product_info-img w-[80px] h-[80px] bg-disable-text-color"></div>
                  ...
                  <div className="cart_product_price-wrapper flex gap-20 items-center">
                    <p className="cart_product_main-price font-medium tracking-[1px] text-accent-color">
                      $3 500
                    </p>
                    <div className="cart_product_count-wrapper flex items-center gap-4 justify-between">
                ...
                <div className="cart_product-wrapper flex items-center gap-[140px] border-b border-disable-color py-10">
                  ...
                  <div className="cart_product_price-wrapper flex gap-20 items-center">
                    ...
                    <div className="cart_product_count-wrapper flex items-center gap-4 justify-between">
                      ...
                      <p className="cart_product_count font-medium tracking-[2px]">3</p>
                      <div className="cart_product_count-plus-btn w-[46px] h-[46px] border border-disable-color rounded-full flex items-center justify-center cursor-pointer">
                        <Image
                          src={"/icons/Icon name=plus.svg"}
                          alt={"plus"}
                ...
                <div className="cart_product-bottom py-10 flex justify-between items-center">
                  <div className="cart_product_promocode flex">
                    <input
                      type="text"
                  ...
                  <button
                    type="button"
                    className="cart_product_promocode-btn uppercase w-[175px] h-[46px] bg-disable-color text-white tracking-[2px] disable-btn"
                  >
                    update cart
                  </button>
                </div>
              </div>
              <div className="cart_right-wrapper"></div>
            </div>
          </div>
        </div>
      </main>
